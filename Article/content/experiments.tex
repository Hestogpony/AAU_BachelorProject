...
\addplot table [x=Charge rate scale, y=naive-time, col sep=comma] {charge_rate.csv};
	\addlegendentry{Naive}
\addplot table [x=Charge rate scale, y=greedy-time, col sep=comma] {charge_rate.csv};
