...
Alternativ notation\\
graph \[G(N,E)\] \\
charge station gives charge rate \[stn_{cha}(n) \rightarrow rate_{cha}\] \\
consumption rate function \[rate_{con}=av^2+bv+c\ \] \\
\[T(v,(u, n)) = \frac{D(u, n)}{v} + \frac{rate_{con}(v) * D(u, n) - Bat_{cur}}{stn_{cha}(n)}\]
}